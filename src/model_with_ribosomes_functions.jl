module ModelWithRibosomes
    ...
    function limit_of_differences(alpha, beta, gamma, T)
        return (beta *(alpha  *(4*exp(gamma *T)-1) *(gamma *T *(gamma *T*(gamma *T *(gamma ^3*T^3+780*gamma *T+4290)+8100)-900)-4*exp(gamma *T) *(gamma *T *(gamma *T*(gamma *T *(gamma ^3*T^3+555*gamma *T+1530)+7290)+2160)-1440)+2*exp(2 *gamma *T) *(gamma *T*(gamma *T *(gamma *T *(2*gamma ^3*T^3+660 *gamma *T-3945)+6750)+4770)-1440)-2880)+20 *gamma ^2*T *(gamma *T*(gamma *T*(gamma *T*(13 *gamma *T+60)-6)-1152)+exp(gamma *T)*(2 *gamma *T*(gamma *T*(31*gamma *T*(3-4 *gamma*T)+87)+3888)+3888)-8*exp(3 *gamma *T)*(gamma *T*(gamma *T*(2 *gamma *T*(13 *gamma *T-90)+591)-540)-648)+4*exp(2 *gamma *T)*(gamma *T*(gamma *T*(gamma *T*(137 *gamma *T-333)+510)-3276)-2160)-432))-90*gamma ^4*T^2 *(-6*exp(gamma *T)+8*exp(2*gamma *T)+1)*(gamma *(-T)*(gamma *T*(gamma *T+6)+6)+2*exp(gamma *T)*(gamma *T*(gamma *T*(gamma *T-6)+15)-12)+24))/(4*(beta*(alpha  *(gamma *(-T) *(2*gamma *T *(gamma *T *(17 *gamma ^3*T^3+300 *gamma*T+840)+810)-225)+4*exp(gamma *T) *(gamma *T *(2 *gamma*T *(gamma *T *(34 *gamma ^3*T^3+420*gamma*T+1335)+1620)+315)-1080)+4*exp(3 *gamma *T) *(gamma *T *(2*gamma *T *(gamma *T *(68 *gamma ^3*T^3-240 *gamma*T-75)+1485)+2385)-720)-5*exp(2 *gamma *T) *(gamma *T *(2*gamma *T *(gamma *T *(68 *gamma ^3*T^3+336 *gamma*T+1569)+2889)+2205)-1296)+720)+10 *gamma ^2*T*(gamma*(-T)*(gamma *T*(gamma *T*(61 *gamma*T-138)+408)+576)+16*exp(3 *gamma *T)*(gamma*T*(gamma *T*(gamma *T*(61 *gamma*T-90)-6)+135)+162)+2*exp(gamma *T)*(gamma *T*(gamma *T*(gamma *T*(208 *gamma*T-291)+1218)+1944)+972)-4*exp(2 *gamma *T)*(gamma *T*(gamma *T*(gamma *T*(269 *gamma*T-333)+798)+1638)+1080)-216))+45*gamma ^4*T^2 *(-6*exp(gamma *T)+8*exp(2*gamma *T)+1)*(gamma *T*(gamma*T*(12-13 *gamma *T)-6)+2*exp(gamma *T)*(gamma *T*(gamma *T*(13 *gamma*T-6)-3)+6)-12)))
